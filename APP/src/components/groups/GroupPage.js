                                    ...
                                    <div className="iq-card-body">
                                        ...
                                        <div className="friend-list-tab mt-2">
                                            <ul className="nav nav-pills d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
                                                <li>
                                                    <a className="nav-link active" data-toggle="pill" href="profile.html#all-friends">All Friends</a>
                                                </li>
                                                <li>
                                                    <a className="nav-link" data-toggle="pill" href="profile.html#recently-add">Recently Added</a>
                                                </li>
                                                <li>
                                                    <a className="nav-link" data-toggle="pill" href="profile.html#closefriends">Close friends</a>
                                                </li>
                                                <li>
                                                    <a className="nav-link" data-toggle="pill" href="profile.html#home">Home/Town</a>
                                                </li>
                                                <li>
                                                    <a className="nav-link" data-toggle="pill" href="profile.html#following">Following</a>
                                                </li>
                                            </ul>
                                            <div className="tab-content">
                                                                        ...
                                                                        <div className="iq-card-header-toolbar d-flex align-items-center">
                                                                            <div className="dropdown">
                                                                                ...
                                                                                <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton01">
                                                                                    <a className="dropdown-item" href="profile.html#">Get Notification</a>
                                                                                    <a className="dropdown-item" href="profile.html#">Close Friend</a>
                                                                                    <a className="dropdown-item" href="profile.html#">Unfollow</a>
                                                                                    <a className="dropdown-item" href="profile.html#">Unfriend</a>
                                                                                    <a className="dropdown-item" href="profile.html#">Block</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                <div className="iq-card">
                                    <div className="iq-card-body">
                                        ...
                                        <div className="friend-list-tab mt-2">
                                            <ul className="nav nav-pills d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
                                                <li>
                                                    <a className="nav-link active" data-toggle="pill" href="profile.html#photosofyou">Photos of You</a>
                                                </li>
                                                <li>
                                                    <a className="nav-link" data-toggle="pill" href="profile.html#your-photos">Your Photos</a>
                                                </li>
                                            </ul>
                                            <div className="tab-content">
                                                                    ...
                                                                    <div className="image-hover-data">
                                                                        <div className="product-elements-icon">
                                                                            <ul className="d-flex align-items-center m-0 p-0 list-inline">
                                                                                <li><a href="profile.html#" className="pr-3 text-white"> 60 <i className="ri-thumb-up-line" /> </a></li>
                                                                                <li><a href="profile.html#" className="pr-3 text-white"> 30 <i className="ri-chat-3-line" /> </a></li>
                                                                                <li><a href="profile.html#" className="pr-3 text-white"> 10 <i className="ri-share-forward-line" /> </a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    <a href="profile.html#" className="image-edit-btn" data-toggle="tooltip" data-placement="top" title data-original-title="Edit or Remove"><i className="ri-edit-2-fill" /></a>
                                                                </div>
                                                            </div>
                                                            <div className="col-md-6 col-lg-3 mb-3">
                                                                <div className="user-images position-relative overflow-hidden">
