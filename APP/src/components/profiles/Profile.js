                            ...
                            <div className="iq-card">
                                ...
                                <div className="iq-card-body">
                                    <ul className="profile-img-gallary d-flex flex-wrap p-0 m-0">
                                        ...
                                        <li className="col-md-4 col-6 pl-2 pr-0"><a href="javascript:void();"><img src="/images/page-img/g4.jpg" alt="gallary-image" className="img-fluid" /></a></li>
                                        <li className="col-md-4 col-6 pl-2 pr-0"><a href="javascript:void();"><img src="/images/page-img/g5.jpg" alt="gallary-image" className="img-fluid" /></a></li>
                                        <li className="col-md-4 col-6 pl-2 pr-0"><a href="javascript:void();"><img src="/images/page-img/g6.jpg" alt="gallary-image" className="img-fluid" /></a></li>
                                    </ul>
                                </div>
                            </div>
